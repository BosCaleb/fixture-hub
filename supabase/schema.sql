...
create table if not exists public.tournaments (
  ...
  tiebreak_rules jsonb not null default '[]'::jsonb,
  playoff_qualification text,
  placement_rules text,
  regulation_length integer,
  extra_time_allowed boolean not null default false,
  penalty_rules text,
  draws_allowed_pools boolean not null default true,
  draws_allowed_playoffs boolean not null default false,
  scoring_rules text,
  forfeit_rule text,
  late_arrival_rule text,
  forfeit_score_treatment text,
  invite_code text,
  banner_path text,
  background_path text,
  theme_color text,
  secondary_color text,
  sponsor_names jsonb not null default '[]'::jsonb,
  ...
  entry_fee text,
  max_teams_registration integer,
  age_group text,
  gender_category text,
  school_club_category text,
